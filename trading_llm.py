...
def createPlan():
    ...
    if float(buyingPower) <= 100.0:
        ...
        You currently have numerous tools at your disposal such as "get_specific_ticker_symbol_market_snapshots" to assess what actions you want to take between selling, or holding current positions. The tool gets you a current snapshot of all the stocks you want to analyze more closely to help make your decision for the next 30 minutes by giving you data on latest trade, latest quote, yesterday bar chart and today's current chart as well as the current minute interval bar candle.
        Use the tool's response to further your technical analysis. Make a decision on what stocks to sell for the next 30 minutes or to hold your current positions. Do not sell stocks that currently have an active order! Do not sell positions that you do not have! Please be very specific in the actions you want to take including price to sell, quantity to sell, etc and explain your reasoning and technical analysis for each."""]
    elif portfolioState == []:
        prompt = [f"""You are an expert stock day trader. You make trades every 30 minutes to maximize profits. You can only buy. You have nothing to sell. You only have ${buyingPower} dollars in USD. Do not go over this limit for choosing what stocks to buy and at what quantity! Consider your open orders: {orderState}. After viewing the yearly, monthly, weekly, and the day bar charts earlier in our context and previous messages keep them in mind. Prioritize day trading strategies
        ...
        You currently have numerous tools at your disposal such as "get_specific_ticker_symbol_market_snapshots" to assess what actions you want to take between buying, or holding current positions or if you want to get new positions. The tool gets you a current snapshot of all the stocks you want to analyze more closely to help make your decision for the next 30 minutes by giving you data on latest trade, latest quote, yesterday bar chart and today's current chart as well as the current minute interval bar candle.
        Use the tool's response to further your technical analysis. Make a decision on what stocks to buy for the next 30 minutes or to hold your current positions or new positions. Consider all ticker symbols that have been analyzed and ones in current positions. Do not buy stocks that currently have an active order! Please be very specific in the actions you want to take including price to buy, quantity to buy, etc and explain your reasoning and technical analysis for each."""]
    else:
        prompt = [f"""You are an expert stock day trader. You only have ${buyingPower} dollars in USD. Do not go over this limit for choosing what stocks to buy and at what quantity! Consider your current portfolio: {portfolioState} and consider your open orders: {orderState}. You make trades every 30 minutes to maximize profits so view these trades as short term. After viewing the yearly, monthly, weekly, and the day bar charts earlier in our context and previous messages keep them in mind. Prioritize day trading strategies
        and the current day bar chart analysis and the market snapshot data from your tool with only some minor influence from the other longer interval charts as well as use the performances of your current positions and their intraday performance. Consider all ticker symbols that have been analyzed. Let's move to make market decisions.
        ...
        Use the tool's response to further your technical analysis. Make a decision on what stocks to buy and sell for the next 30 minutes or to hold your current positions or new positions. Consider all ticker symbols that have been analyzed and ones in current positions. Do not buy or sell stocks that currently have an active order! Do not sell positions that you do not have! Please be very specific in the actions you want to take including price to buy/sell, quantity to buy/sell, etc and explain your reasoning and technical analysis for each."""]
