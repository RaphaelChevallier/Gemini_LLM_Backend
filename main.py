...
MainAgentModel = GenerativeModel("gemini-1.0-pro", tools=[llm_builds.correct_address_input])
...
def questionLLMs(input, user_id):
    ...
    response = llm_builds.get_chat_response(chat, input, MainAgentModel, relevant_history)
    return response